		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav " id="side-menu">
					<li class="sidebar-profile text-center pint-logo">
					...
					<li class="sidebar-profile text-center">
						<span class="sidebar-profile-picture pint-anch">
							<a href="#" target="_blank">
								<img src="<?php echo esc_url(WEBLIZAR_PINIT_PLUGIN_URL.'img/pint.jpg' ); ?>" alt="Profile Picture"/>
							</a>
							<a href="http://demo.weblizar.com/pinterest-feed-pro/" target="_blank" class="pint-btn">View Demo</a>
							<a href="https://weblizar.com/plugins/pinterest-feed-pro/" target="_blank" class="pint-btn">Go Pro $18</a>
						</span>
					</li>
				</ul>
			</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<ul class="nav nav-pills">
					<li class="active text-m"><a data-toggle="tab" href="#pinit-settings-tab"><strong><?php _e('Settings', WEBLIZAR_PINIT_TD); ?></strong> <span class="pull-right close-conversation margin-left "><i class="fa fa-cog"></i></span></a></li>
					<li class=""><a data-toggle="tab" href="#exclude-images"><strong><?php _e('Exclude Images', WEBLIZAR_PINIT_TD); ?></strong> <span class="pull-right close-conversation margin-left "><i class="fa fa-ban"></i></span></a></li>
					<li class=""><a data-toggle="tab" href="#exclude-pages"><strong><?php _e('Exclude Pages', WEBLIZAR_PINIT_TD); ?></strong> <span class="pull-right close-conversation margin-left "><i class="fa fa-ban"></i></span></a></li>
				...
				<div class="tab-content">
					...
					<div id="pinit-settings-tab" class="tab-pane fade active in">
						...
						<button id="pinitsave" name="pinitsave" class="button button-primary" type="button" onclick="return SaveSettings();"><strong><i class="fa fa-save"></i>&nbsp;&nbsp;<?php _e('Settings', WEBLIZAR_PINIT_TD); ?></strong></button>
