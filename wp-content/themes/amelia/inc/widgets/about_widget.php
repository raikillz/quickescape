...
class pixelshow_about_widget extends WP_Widget {
	...
	{
		$widget_ops = array( 'classname' => 'pixelshow_about_widget', 'description' => esc_html__('A widget that displays an About widget', 'amelia') );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'pixelshow_about_widget' );
		parent::__construct( 'pixelshow_about_widget', esc_html__('Amelia: About Me', 'amelia'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_html($this->get_field_id('title')); ?>"><?php echo esc_html( 'Title:', 'amelia' ); ?></label>
		...
		<!-- image url -->
		<p>
			<label for="<?php echo esc_html($this->get_field_id( 'image' )); ?>"><?php echo esc_html( 'Image URL:', 'amelia' ); ?></label>
		...
		<!-- round image -->
		<p>
			<label for="<?php echo esc_html($this->get_field_id( 'round' )); ?>"><?php echo esc_html( 'Make image a circle:', 'amelia' ); ?></label>
			...
			<br><small><?php echo esc_html( 'For a perfect circle your image need to have the same height and width. For example: 260x260', 'amelia' ); ?></small>
		</p>
		
		<!-- description -->
		<p>
			<label for="<?php echo esc_html($this->get_field_id( 'description' )); ?>"><?php echo esc_html( 'About me text:', 'amelia' ); ?></label>
